...
Given below is complete implementation of singly cicular linked list:
...
Similarly, implementation of circular list using doubly linked list can be
implemented which will make delete much simpler in particular.
