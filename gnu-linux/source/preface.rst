...
The emphasis has been given on examples which one can try on his/her own
...
To make matters simple I complement and supplement coreutils.pdf which is
avalable from GNU's weside at the url
http://www.gnu.org/software/coreutils/manual/coreutils.pdf however, it is not
a copy in the exact sense but a more verbose description of this document.
...
To generate the pdf copy LaTeX is used from same source of Sphinx therefore
definitely some credit is due to Donald Knuth and Leslie Lamport. Special
thanks to my cousin's Shashi Kant and Ravi Shankar for their help at vaious
stages of this books writing.
...
an email at < shivshankar [dot] dayal at gmail [dot] com > . I will try to fix
all errors and incorporate your valuable suggestions. Also, I have created a
simple small web question/answer web application just to help readers which is
deployed at http://kunjika.libreprogramming.org which you can use to post your
comments, suggestions, corrections etc. Kunjika will also be used to hold my
blog posts just as a question. Rather than personal email Kunjika is a
preferred mode of communication because it will help me reduce redundancy for
providing the answers and users can actually do a search before
asking/reporting which is not possible over email interactions.
